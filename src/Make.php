...
class Make
{
     ...
     * @var DOMElement
     */
    protected $obterPdfDua;

	/**
     * @var DOMElement
     */
    protected $consAreaServico;
    ...
    */
	...
	protected function montaDuaConsultaAreaServico(){
		
		$this->dom->appendChild($this->consAreaServico);
	...
	protected function montaDuaObterPdf(){
		
		$this->dom->appendChild($this->obterPdfDua);
	...
	public function tagObterPdfDua(stdClass $std){
		...
		$identificador = 'A <obterPdfDua> - ';

        $this->obterPdfDua = $this->dom->createElement("obterPdfDua");
		
		$this->obterPdfDua->setAttribute('versao', $std->versao);

		$this->obterPdfDua->setAttribute('xmlns', 'http://www.sefaz.es.gov.br/duae');
	...
	public function tagConsAreaServico(stdClass $std){
		...
		$identificador = 'A <consAreaServico> - ';

        $this->consAreaServico = $this->dom->createElement("consAreaServico");
		
		$this->consAreaServico->setAttribute('versao', $std->versao);

		$this->consAreaServico->setAttribute('xmlns', 'http://www.sefaz.es.gov.br/duae');

		$this->dom->addChild(
            $this->consAreaServico,
            "tpAmb",
            $std->tpAmb,
            true,
            $identificador . "Identificação do Ambiente"
