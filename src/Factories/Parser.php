...
class Parser
{
	...
	protected $methods = array(
		...
		'duaConsultaAreaServico' => 'DuaConsultaAreaServico',
	);
    ...
    */
    ...
    protected function aEntityDuaObterPdf(\stdClass $std)
    {
        ...
        $this->make->tagObterPdfDua($std);
    }

	/**
     * Create tag consAreaServico [A]
     * A|versao|tpAmb|cnpj
     * @param stdClass $std
     * @return void
     */
    protected function aEntityDuaConsultaAreaServico(\stdClass $std)
    {
		$std->versao = '1.00';

        $this->make->tagConsAreaServico($std);
    }
